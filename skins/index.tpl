				...
				<div class="currencylogin">
					...
					<div class="login">
						...
						<div id="auth" class="authWindow">
							Активируйтесь в один click
							<br>
							<br>
							<button onclick="fb_auth();return false;">Login by Facebook</button>
							<br>
							<br>
							или же через логин и пароль
							<br>
							<br>
	...
	<div class="menusearch">
					...
					<div class="dropwomens">
						...
						<div class="clmenu">
							...
							<div class="drop-menu-choise">
								...
								<a href="/"><h2 clas.s="h2-text">SHIRTS & BLOUSES</h2></a>
		...
		<div class="search">
			<form action="" method="get">
				...
				<input type="image" src="/skins/img/search.png" class="search-img">
			</form>
		</div>
	</div>
